CREATE DATABASE IF NOT EXISTS SchoolServicesYael;
USE SchoolServicesYael;
-- TABLES
-- User
CREATE TABLE User (
...
CREATE TABLE FamilyData (
    idFamilyData INT PRIMARY KEY AUTO_INCREMENT,
    name VARCHAR(50) NOT NULL,
...
CREATE TABLE LifeInsurance (
    idLifeInsurance INT PRIMARY KEY AUTO_INCREMENT,
...
-- Period
CREATE TABLE Period (
    idPeriod INT PRIMARY KEY AUTO_INCREMENT,
    name VARCHAR(50) NOT NULL,
    startDate DATE NOT NULL,
    endDate DATE NOT NULL,
...
CREATE TABLE Education (
    idEducation INT PRIMARY KEY AUTO_INCREMENT,
...
VALUES ('Maria', 'Ortiz', 'Madre', '123-456-7890', 'maria@example.com', '123 Main St', 2, 1, 1, '2023-10-23'),
       ('Juana', 'Martinez', 'Madre', '987-654-3210', 'juana@example.com', '456 Elm St', 3, 2, 1, '2023-10-23'),
       ('Enrique', 'Ramos', 'Padre', '555-123-4567', 'enrique@example.com', '789 Oak St', 1, 1, 1, '2023-10-23');
...
VALUES ('LI-003', '123 Insure', '2023-03-10', '2028-03-09', 'Enrique Ramos', 750000.00, 300000.00, 200.00, 12, 1, '2023-10-23'),
...
VALUES ('Fall 2023', '2023-09-01', '2023-12-15', 106, 1, 1, '2023-10-23'),
       ('Spring 2024', '2024-01-15', '2024-05-30', 137, 2, 1, '2023-10-23'),
       ('Summer 2024', '2024-06-15', '2024-08-31', 78, 2, 1, '2023-10-23');

INSERT INTO Education (educationLevel, startDate, endDate, idStudent, idUserCreate, creationDate)
VALUES ('High School', '2018-09-01', '2021-06-30', 3, 2, 1, '2023-10-23'),
       ('Bachelor Degree', '2021-09-01', '2025-06-30', 4, 1, 1, '2023-10-23'),
       ('High School', '2020-09-01', '2024-06-30', 2, 1, 1, '2023-10-23');
